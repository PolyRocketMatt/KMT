 ...
 * @since 0.0.1
 *
 * Represents a left half-open interval of floating-point numbers between start and end.
 *
 ...
 */
class LeftOpenFloatInterval(private val start: Float, private val end: Float, private val accuracy: Float) : ClosedFloatInterval(start, end, accuracy), HalfOpenInterval<Float> {
