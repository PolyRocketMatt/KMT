...
abstract class GaussianIntegrator<T>(val rule: GaussianQuadratureRule) : Integrator<T> {
    ...
    companion object {
        val ONE_POINT_WEIGHTS = doubleArrayOf(2.0)
        val ONE_POINT_POINTS = doubleArrayOf(0.0)

        val TWO_POINT_WEIGHTS = doubleArrayOf(1.0, 1.0)
        val TWO_POINT_POINTS = doubleArrayOf(-0.5773502691896257, 0.5773502691896257)

        val THREE_POINT_WEIGHTS = doubleArrayOf(0.8888888888888888, 0.5555555555555556, 0.5555555555555556)
        val THREE_POINT_POINTS = doubleArrayOf(0.0, -0.7745966692414834, 0.7745966692414834)

        val FOUR_POINT_WEIGHTS = doubleArrayOf(0.6521451548625461, 0.6521451548625461, 0.3478548451374538, 0.3478548451374538)
        val FOUR_POINT_POINTS = doubleArrayOf(-0.3399810435848563, 0.3399810435848563, -0.8611363115940526, 0.8611363115940526)

        val FIVE_POINT_WEIGHTS = doubleArrayOf(0.5688888888888889, 0.4786286704993665, 0.4786286704993665, 0.23692688505618908, 0.23692688505618908)
        val FIVE_POINT_POINTS = doubleArrayOf(0.0, -0.5384693101056831, 0.5384693101056831, -0.906179845938664, 0.906179845938664)
